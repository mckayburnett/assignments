...
function Game(props){
    ...
    let {inputs, save, lock, setLock, lockAnswer, gameQuestions, getCat1, getCat2, getCat3, getCat4, getCat5, category1, category2, category3, category4, category5} = useContext(Context)
